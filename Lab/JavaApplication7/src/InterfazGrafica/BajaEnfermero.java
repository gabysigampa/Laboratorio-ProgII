...
public class BajaEnfermero extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Baja Enfermero");

        jLabel2.setFont(new java.awt.Font("Bell MT", 0, 18)); // NOI18N
        jLabel2.setText("Ingrese DNI del Enfermero");
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        ...
        ColeccionEmpleados bajaEnfermero;
        bajaEnfermero= null;
        
        for(ColeccionEmpleados i: empleados.getEnfermeros()){
            if(i.getDni().equals(dni))
                bajaEnfermero=i;
        }
        
        if(bajaEnfermero!=null){
            empleados.getEnfermeros().remove(bajaEnfermero);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaEnfermero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajaEnfermero().setVisible(true);
            }
        });
    }
