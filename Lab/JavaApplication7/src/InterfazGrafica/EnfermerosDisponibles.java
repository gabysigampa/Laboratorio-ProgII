 ...
 * @author Fernando
 */
public class EnfermerosDisponibles extends javax.swing.JFrame {

    /**
     * Creates new form EnfermerosDisponibles
     */
    public EnfermerosDisponibles() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnfermerosDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnfermerosDisponibles().setVisible(true);
            }
        });
    }
