 ...
 * @author Fernando
 */
public class ChoferesDisponibles extends javax.swing.JFrame {

    /**
     * Creates new form ChoferesDisponibles
     */
    public ChoferesDisponibles() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChoferesDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChoferesDisponibles().setVisible(true);
            }
        });
    }
